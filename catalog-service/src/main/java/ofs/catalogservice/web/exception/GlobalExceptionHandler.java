package ofs.catalogservice.web.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    public static final URI NOT_FOUND_TYPE = URI.create("https://api.ofs.com/errors/not-found");
    public static final URI ISE_FOUND_TYPE = URI.create("https://api.ofs.com/errors/server-error");
